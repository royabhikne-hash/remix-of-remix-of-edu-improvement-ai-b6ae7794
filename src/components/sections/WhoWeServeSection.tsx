  ...
  const audiences = [
    {
      ...
      benefits: [
        "Board-wise MCQ tests for targeted practice",
        "Weekly tests to track consistency",
        "District, school & coaching-wise ranking",
    ...
    {
      icon: School,
      title: "For Schools & Coaching Centers",
      ...
      benefits: [
        ...
        "Board-wise performance tracking",
    ...
    },
    {
      ...
      benefits: [
        ...
        "Regular progress & ranking updates",
        "Peace of mind about engagement",
        "Clear communication with schools & coaching",
      ],
