...
const HeroSection = () => {
  ...
  // On mobile (reducedMotion=true), all transforms output static "0%"/0 values
      ...
      <div className="section-container relative z-10 py-8 md:py-0">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <motion.div
            ...
            initial={{ opacity: 0, scale: 0.9, x: reducedMotion ? 0 : 60 }}
            ...
            >
              <div className="flex items-center gap-2 md:gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs md:text-sm text-muted-foreground">Updated in real-time</p>
                </div>
              </div>
            </motion.div>
